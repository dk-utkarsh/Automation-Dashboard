      ...
      <div className="flex items-center justify-center min-h-[60vh] px-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 text-sm mt-1">Enter the password to access this department</p>
          </div>
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#0A2E4D] transition-colors"
                >
            ...
            <Link to="/" className="block text-center text-slate-500 hover:text-[#0A2E4D] text-sm font-medium mt-4">
              Back to Dashboard
            </Link>
          </form>
        </div>
