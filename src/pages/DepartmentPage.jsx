  ...
  if (error) {
    return (
      <div className="text-center py-20">
        ...
        <Link to="/" className="text-[#2B6CB0] mt-4 inline-block hover:underline font-bold">Back to Dashboard</Link>
      </div>
    );
  }
    ...
    <div className="px-8 py-10 md:px-16 max-w-[1400px] mx-auto">
      ...
      <div className="mb-8 animate-fade-up">
        <div className="flex items-center gap-2 text-sm text-slate-500 mb-4">
          ...
          <span className="text-[#2B6CB0] font-semibold">{department.name}</span>
        </div>
        <h2 className="text-4xl font-extrabold text-[#2B6CB0] tracking-tight flex items-center gap-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
        <div className="glass-card rounded-xl p-6 animate-fade-up stagger-1">
          ...
          <p className="text-3xl font-black text-[#2B6CB0] mt-2">{totalTools}</p>
        </div>
        ...
        <div className="bg-[#2B6CB0] rounded-xl p-6 text-white animate-fade-up stagger-4">
