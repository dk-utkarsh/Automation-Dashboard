...
export default function ToolForm() {
  ...
  return (
    <div className="max-w-lg">
      <Link to={`/admin/departments/${departmentId}/tools`} className="text-slate-500 hover:text-[#1A5276] text-sm font-medium mb-6 inline-flex items-center gap-1">
        <span className="material-symbols-outlined text-lg">arrow_back</span> Back to Tools
      </Link>
      <h2 className="text-2xl font-extrabold text-[#1A5276] mb-6">{isEdit ? "Edit Tool" : "New Tool"}</h2>
