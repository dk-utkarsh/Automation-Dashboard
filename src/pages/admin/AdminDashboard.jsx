              ...
              <tr key={dept.id} className="border-b border-slate-50 hover:bg-[#F8FAFC] transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-[#1A5276] font-bold">{dept.name}</div>
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex items-center justify-end gap-3">
                    ...
                    <Link to={`/admin/departments/${dept.id}/edit`} className="text-slate-500 hover:text-[#1A5276] text-sm font-semibold">Edit</Link>
