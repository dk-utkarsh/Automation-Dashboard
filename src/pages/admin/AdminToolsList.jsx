...
export default function AdminToolsList() {
  ...
  return (
    <div>
      <Link to="/admin" className="text-slate-500 hover:text-[#0A2E4D] text-sm font-medium mb-6 inline-flex items-center gap-1">
              ...
              <tr key={tool.id} className="border-b border-slate-50 hover:bg-[#F8FAFC] transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-[#0A2E4D] font-bold">{tool.name}</div>
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex items-center justify-end gap-3">
                    <Link to={`/admin/departments/${id}/tools/${tool.id}/edit`} className="text-slate-500 hover:text-[#0A2E4D] text-sm font-semibold">Edit</Link>
