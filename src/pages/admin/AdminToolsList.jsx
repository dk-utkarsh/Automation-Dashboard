  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-extrabold text-[#3B8FCF] flex items-center gap-2"><span>{department.icon}</span> {department.name} — Tools</h2>
              ...
              <tr key={tool.id} className="border-b border-slate-50 hover:bg-[#F8FAFC] transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-[#3B8FCF] font-bold">{tool.name}</div>
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex items-center justify-end gap-3">
                    <Link to={`/admin/departments/${id}/tools/${tool.id}/edit`} className="text-slate-500 hover:text-[#3B8FCF] text-sm font-semibold">Edit</Link>
