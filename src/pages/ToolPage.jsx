...
export default function ToolPage() {
  ...
  if (error) {
    return (
      <div className="text-center py-20 bg-[#F4F7FA] min-h-screen">
        ...
        <Link to={`/department/${slug}`} className="text-[#1A5276] mt-4 inline-block hover:underline font-bold">Back</Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F4F7FA]">
      <header className="bg-[#1A5276] px-6 md:px-8 py-3 flex items-center justify-between shadow-md">
