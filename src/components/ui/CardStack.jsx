  ...
  return (
    ...
    >
      <div
        ...
        onKeyDown={onKeyDown}
      >
        <div className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full bg-black/5 blur-3xl dark:bg-white/5" />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-40 w-[76%] rounded-full bg-black/10 blur-3xl dark:bg-black/30" />
            ...
            {items.map((it, idx) => (
              <button
                ...
                className={cn(
                  ...
                  idx === active ? "bg-[#0A2E4D] dark:bg-white" : "bg-[#0A2E4D]/30 dark:bg-white/30 hover:bg-[#0A2E4D]/50 dark:hover:bg-white/50",
                )}
              />
            ))}
          </div>
          {activeItem.href && (
            <a href={activeItem.href} target="_blank" rel="noreferrer" className="text-slate-400 hover:text-[#0A2E4D] dark:hover:text-white transition">
    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-slate-100 dark:bg-slate-800 text-sm text-slate-400">No image</div>
        )}
      </div>
