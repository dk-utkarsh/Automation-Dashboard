...
export function GlowCard({ children, className = "", glowColor = "blue" }) {
  const cardRef = useRef(null);

  useEffect(() => {
    if (!cssInjected) {
      const style = document.createElement("style");
      style.textContent = beforeAfterCSS;
  ...
  return (
    <div
      ...
      data-glow
      style={cardStyle}
      className={`rounded-2xl relative shadow-[0_1rem_2rem_-1rem_rgba(0,0,0,0.2)] backdrop-blur-[5px] ${className}`}
    >
      <div data-glow />
      {children}
    </div>
