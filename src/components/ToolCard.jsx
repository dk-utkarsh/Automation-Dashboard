...
export default function ToolCard({ tool, departmentSlug }) {
  return (
    ...
    >
      ...
      <span className="px-5 py-2.5 text-[10px] font-black uppercase tracking-widest bg-[#F4F7FA] text-[#0A2E4D] hover:bg-[#FF8C00] hover:text-white rounded-lg transition-all shrink-0">
        Open Tool
      </span>
    </Link>
  );
