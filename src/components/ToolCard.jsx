...
export default function ToolCard({ tool, departmentSlug }) {
  return (
    ...
    >
      <div className="flex items-start gap-5">
        ...
        <div>
          <div className="flex items-center gap-3 flex-wrap">
            <h4 className="text-base font-bold text-[#1A5276] group-hover:text-[#FF8C00] transition-colors">{tool.name}</h4>
      ...
      <span className="px-5 py-2.5 text-[10px] font-black uppercase tracking-widest bg-[#F4F7FA] text-[#1A5276] hover:bg-[#FF8C00] hover:text-white rounded-lg transition-all shrink-0">
        Open Tool
      </span>
    </Link>
  );
